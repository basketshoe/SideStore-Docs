...
Vai nella pagina Home affinché finisca. Non sappiamo perché succeda, ma potrebbe avere a che fare con l'utilizzo della VPN per ordinare a `installd` di auto-eseguire il refresh di SideStore.
...
Apri una issue sulla nostra pagina GitHub per reportare un bug o richiedere una funzionalità (con le etichette adeguate)!
